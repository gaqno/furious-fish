                            ...
                            <table class="table">
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td>
                                      <nuxt-link href="/product-details" class="order__title">University seminar series global.</nuxt-link></td>
                                    <td>$144.00</td>
                                    <td>
                                      <nuxt-link href="/product-details" class="order__view-btn">View</nuxt-link></td>
                                  </tr>
                                  <tr>
                                    <td class="order__id">#2441</td>
                                    <td>
                                      <nuxt-link href="/product-details" class="order__title">Web coding and apache basics</nuxt-link></td>
                                    <td>$59.54</td>
                                    <td>
                                      <nuxt-link href="/product-details" class="order__view-btn">View</nuxt-link></td>
                                  </tr>
