                    ...
                    <div class="shop__content-area">
                        <div class="shop__header d-sm-flex justify-content-between align-items-center mb-40">
                            <div class="shop__header-left">
                                <div class="show-text">
                                    <span>Showing 1–{{ state.products.slice(pageStart, pageStart + countOfPage).length }} of
                                        {{ state.products.length }} results</span>
                                </div>
                            </div>
                            <div
                                ...
                                <ul class="nav nav-pills" id="pills-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="pills-grid-tab" data-bs-toggle="pill"
                                            href="#pills-grid" role="tab" aria-controls="pills-grid" aria-selected="true"><i
                                                class="fas fa-th"></i></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="pills-list-tab" data-bs-toggle="pill" href="#pills-list"
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-grid" role="tabpanel"
                                ...
                                <div class="row custom-row-10">
                                    ...
                                    <div v-for="(item, i) in state.filterProducts.slice(pageStart, pageStart + countOfPage)"
                                        :key="i" class="col-xl-4 col-lg-4 col-md-6 col-sm-6 custom-col-10">
                            ...
                            <div class="tab-pane fade" id="pills-list" role="tabpanel" aria-labelledby="pills-list-tab">
                                ...
                                <product-list-item
                                    v-for="(item, i) in state.filterProducts.slice(pageStart, pageStart + countOfPage)"
                                    :key="i" :item="item" />
