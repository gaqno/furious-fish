            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="section__wrapper text-center">
                        <h3 class="section__title-2"><span>Nossos BEST SELLERS!</span></h3>
                    </div>
                </div>
            </div>
            <div class="row mt-40">
                <div class="col-xl-6 col-lg-6">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="row">
                                <div v-for="(item, i) in sm_best_prd.slice(0, 2)" :key="i"
                                    class="col-xl-6 col-lg-12 col-md-6">
                ...
                <div class="col-lg-6 col-lg-6">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                <div v-for="(item, i) in sm_best_prd.slice(2, 4)" :key="i"
                                    class="col-xl-6 col-lg-12 col-md-6">
                                    <div class="product__item mb-40">
                                        <product-item-two :item="item" />
                                    </div>
...
const best_sale_prd = graphql_products.products.filter((p) => p.bestSeller);
