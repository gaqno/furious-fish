      ...
      <div class="col-xl-8 col-lg-8">
        <div class="product__content p-relative">
          ...
          <div class="add-cart-list d-sm-flex align-items-center">
            <a href="#" class="add-cart-btn mr-10">+ Carrinho</a>
            <div class="product__action-2 transition-3 mr-20">
              <a @click.prevent="wishlistState.add_wishlist_product(item)" href="#" data-bs-toggle="tooltip"
                data-bs-placement="top" title="Adicionar a lista de desejos">
              ...
              <a @click.prevent="store.initialOrderQuantity" href="#" data-bs-toggle="modal"
